...
public class CatalogActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        itemListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                /*Form the content URI of specific item that was clicked on,
                  by appending the "id" (passed as an input to this method) onto the {@link ItemEntry@CONTENT_URI}.
                ...
                Uri currentInventoryUri = ContentUris.withAppendedId(ItemEntry.CONTENT_URI, id);
    ...
    private void insertItem() {
        ...
        values.put(ItemEntry.COLUMN_ITEM_NAME, "Lamp");
        values.put(ItemEntry.COLUMN_ITEM_PRICE, 25.5);
        values.put(InventoryContract.ItemEntry.COLUMN_ITEM_QUANTITY, 3);
        values.put(InventoryContract.ItemEntry.COLUMN_ITEM_SUPPLIER_NAME, "Giove Corporation");
        values.put(ItemEntry.COLUMN_ITEM_SUPPLIER_PHONE, "+4850896562");
